#!/usr/bin/env bash
#
# Build, install and verify dev-portal on a local cluster.
#
#   ./helm/dev-portal/deploy.sh              # build, upgrade, restart, test
#   ./helm/dev-portal/deploy.sh --no-build   # skip the image build
#   ./helm/dev-portal/deploy.sh --no-test    # skip helm test
#
...
SOURCE_DIR="$REPO_ROOT/dev-portal"
